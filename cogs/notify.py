...
class Notify(commands.Cog):
    ...
    @notify.command(name='add', description='특정 스킨이 상점에 떴을때, 당신에게 알림을 줍니다')
    @app_commands.describe(skin='알림을 해줬으면 하는 스킨의 이름')
    ...
    @notify.command(name='list', description='알림 설정을 해둔 스킨들을 보여줍니다')
    # @dynamic_cooldown(cooldown_5s)
    ...
    @notify.command(name='mode', description='알림 모드를설정합니다')
    @app_commands.describe(mode='바꾸고 싶은 모드를 선택해주세요')
    # @dynamic_cooldown(cooldown_5s)
    ...
    @notify.command(name='channel', description='알림 채널을 설정합니다')
    @app_commands.describe(channel='바꾸고 싶은 채널을 선택해주세요')
    # @dynamic_cooldown(cooldown_5s)
    ...
    @notify.command(name='test', description='알림 테스트입니다!')
    # @dynamic_cooldown(cooldown_5s)
